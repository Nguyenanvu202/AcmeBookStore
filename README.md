...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 3d156ff3-7415-48f4-8925-0dbaa4f3d1ef
```

> `3d156ff3-7415-48f4-8925-0dbaa4f3d1ef` is the password of the certificate, you can change it to any password you want.
